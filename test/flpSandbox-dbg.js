		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "PMS Test",
									"targetURL": "#pmsopenui5testpmsopenui5test-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"pmsopenui5testpmsopenui5test-display": {
								"semanticObject": "pmsopenui5testpmsopenui5test",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pmsopenui5test.pmsopenui5test",
									"url": sap.ui.require.toUrl("pmsopenui5test/pmsopenui5test")
								}
							}
						}
					}
